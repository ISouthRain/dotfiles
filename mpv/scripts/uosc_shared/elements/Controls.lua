...
function Controls:init()
	...
	local shorthands = {
		...
		playlist = 'command:list_alt:script-binding uosc/playlist?列表',
		...
		['stream-quality'] = 'command:high_quality:script-binding uosc/stream-quality?画质',
		['open-file'] = 'command:file_open:script-binding uosc/open-file?打开文件',
		['items'] = 'command:list_alt:script-binding uosc/items?播放列表',
