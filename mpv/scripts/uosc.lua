...
function create_default_menu()
	return {
		...
		{title = '画质', value = 'script-binding uosc/stream-quality'},
		{title = '播放列表', value = 'script-binding uosc/items'},
		{title = '章节', value = 'script-binding uosc/chapters'},
		{title = '导航', items = {
			{title = '下一个', hint = 'playlist or file', value = 'script-binding uosc/next'},
			{title = '上一个', hint = 'playlist or file', value = 'script-binding uosc/prev'},
			...
			{title = '打开目录', value = 'script-binding uosc/open-file'},
		},},
		{title = 'Utils', items = {
			{title = '纵横比', items = {
				{title = '默认', value = 'set video-aspect-override "-1"'},
			...
			{title = '截屏', value = 'async screenshot'},
			{title = '文件目录', value = 'script-binding uosc/show-in-directory'},
			{title = '打开配置文件夹', value = 'script-binding uosc/open-config-directory'},
		},},
		{title = '退出', value = 'quit'},
	}
end
